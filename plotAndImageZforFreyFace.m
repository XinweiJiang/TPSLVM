...
axis image;
hold off;
print(figure1,'-depsc','-tiff', '-loose', '-r600', [BASEPATH 'dv_FreyFaceBar1'])

% subplot(1,3,2);
figure2 = figure; 
axes2 = axes('Parent',figure2,'ZColor',[0 0 1],'YTick',zeros(1,0),...
    'YDir','reverse',...
    'YColor',[0 0 1],...
    'XColor',[0 0 1],...%     'Position',[0.437238493723847 0.00226244343891403 0.0638075313807533 0.995475113122174],...
    'Layer','top');
box(axes2,'on');
hold(axes2,'all');
for i = 1:15
...
axis image;
hold off;
print(figure1,'-depsc','-tiff', '-loose', '-r600', [BASEPATH 'dv_FreyFaceBar2'])

% subplot(1,3,3);
figure3 = figure; 
axes3 = axes('Parent',figure3,'ZColor',[0 1 0],'YTick',zeros(1,0),...
    'YDir','reverse',...
    'YColor',[0 1 0],...
    'XColor',[0 1 0],...%     'Position',[0.523012552301235 0 0.0554393305439518 0.997737556561109],...
    'Layer','top');
box(axes3,'on');
hold(axes3,'all');
for i = 1:16
...
print(figure1,'-depsc','-tiff', '-loose', '-r600', [BASEPATH 'dv_FreyFaceBar3'])
