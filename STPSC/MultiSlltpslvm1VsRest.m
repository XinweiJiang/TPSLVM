function [ retAcc ] = MultiSlltpslvm1VsRest( dataSetName, x, y, xx, yy, latentDim, Opt )
...
for i = 1:nClass
    ...
    [retZ, zz, retAcc, distance] = BinarySlltpslvm(  dataSetNameBin, xi, yi, xxi, yyi, latentDim, Opt  );
    Acc = [Acc; [retAcc]];
...
filename = ['demSlltpslvm1VsRest' dataSetName 'Tr' num2str(size(x,1)) 'Te' num2str(size(xx,1)) 'L' num2str(latentDim)];
save([filename]);
