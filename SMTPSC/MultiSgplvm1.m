function [ retZ, zc ] = MultiSgplvm1(  dataSetName, x_tr, out_tr, x_te, out_te, latentDim, Opt  )
...
for i = 1:itersTrain
    ...
    newHyper_X = driverm1(dataSetName,col,outfile,DATAPATH,x_tr,out_tr,x_te,out_te,meth,...
