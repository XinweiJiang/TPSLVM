function model = tpslvmPointOptimise(model, display, iters);

% TPSLVMOPTIMISE Optimise the FGPLVM.
%
%	Description:
%
...
params = tpslvmPointExtractParam(model);
...
if strcmp(func2str(optim), 'optimiMinimize')
  ...
  params = optim('tpslvmPointObjectiveGradient', params, options, model);
else
  % NETLAB style optimization.
  params = optim('tpslvmPointObjective', params,  options, ...
                 'tpslvmPointGradient', model);
end

model = tpslvmPointExpandParam(model, params);
