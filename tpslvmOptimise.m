function model = tpslvmOptimise(model, display, iters);
...
params = tpslvmExtractParam(model);
...
if strcmp(func2str(optim), 'optimiMinimize')
  ...
  params = optim('tpslvmObjectiveGradient', params, options, model);
else
  % NETLAB style optimization.
  params = optim('tpslvmObjective', params,  options, ...
                 'tpslvmGradient', model);
end
