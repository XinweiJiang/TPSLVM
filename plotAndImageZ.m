...
COLORLABLES = [[1 0 0]; [0 1 0]; [0 0 1]; [0.5 0.5 0]; [1 0 1]; [0 1 1]; [0.8 0 0.8]; [1 0.5 0.5]; [0 0.5 0.5]; [0.5 0.5 0.5]];
...
switch ds
    case {'Teapots','TeapotsFT'}
        SCALE = 0.36;BASEIDX = 0;MODNUM = 7;
        S = [76,101,3];
        ROTATEDEGREE = 180;
    case 'Coil'
        SCALE = 0.34;BASEIDX = 0;MODNUM = 5;
        S = [128,128];
        ROTATEDEGREE = 180;
    case {'Face','FaceFT','FaceSmile'}
        SCALE = 0.2;BASEIDX = 0;MODNUM = 20;
        S = [20,28];
        ROTATEDEGREE = 90;
    case 'Hand'
    ...
    case {'Usps0To4','Usps0To4NC','Usps5And3'}
        ...
        S = [16,16];
        ROTATEDEGREE = 90;
    case {'UmistFace','UmistFace1'}
        SCALE = 0.2;BASEIDX = 1;MODNUM = 4;
        S = [112,92];
        ROTATEDEGREE = 180;
    otherwise
